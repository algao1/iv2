...
class Store:
    ...
    def get_glucose(self, start: datetime, end: datetime):
        return self.get_event("glucose", start, end)

    def get_insulin(self, start: datetime, end: datetime):
        return self.get_event("insulin", start, end)

    def get_carbs(self, start: datetime, end: datetime):
        return self.get_event("carbs", start, end)

    def get_event(self, event: str, start: datetime, end: datetime):
